        ...
        <Grid item xs={12} sm={6} md={6}>
          <Paper>
            ...
            {mainCarData.carC.models&&<div style={{padding:'10px'}}>
              {mainCarData.carC.models&&mainCarData.carC.models.map(models => (<Typography key={models.id}>►{models.model}</Typography>))}
            </div>}
          </Paper>
        </Grid>
        <Grid item xs={12} sm={6} md={6}>
          <Paper>
            ...
            {mainCarData.carC.accessory_Options&&<div style={{padding:'10px'}}>
              {mainCarData.carC.accessory_Options&&mainCarData.carC.accessory_Options.map(accessory_Options => (<Typography  key={accessory_Options.id}>►{accessory_Options.option}</Typography>))}
            </div>}
          </Paper>
        </Grid>
      </Grid>
