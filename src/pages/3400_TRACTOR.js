...
const CarB = () => (
  <div>
    <Layout>
        ...
        <Grid item xs={12} sm={6} md={6}>
          <Paper>
            ...
            {mainCarData.carB.models&&<div style={{padding:'10px'}}>
              {mainCarData.carB.models&&mainCarData.carB.models.map(models => (<Typography  key={models.id}>►{models.model}</Typography>))}
            </div>}
          </Paper>
        </Grid>
        <Grid item xs={12} sm={6} md={6}>
          <Paper>
            ...
            {mainCarData.carB.accessory_Options&&<div style={{padding:'10px'}}>
              {mainCarData.carB.accessory_Options&&mainCarData.carB.accessory_Options.map(accessory_Options => (<Typography  key={accessory_Options.id}>►{accessory_Options.option}</Typography>))}
            </div>}
          </Paper>
        </Grid>
      </Grid>
      ...
      <div style={{textAlign:'center'}}>
        <img src={mainCarData.carB.features}  alt={mainCarData.carB.features}/>
      </div>
      <br />
