...
const rows = [
  createData('Toyota Aqua 2017', 159, 6.0, 24, 4.0),
  createData('Toyota Aqua 2018', 237, 9.0, 37, 4.3),
  createData('Toyota Aqua 2019', 262, 16.0, 24, 6.0),
  createData('Toyota Aqua + 2018', 305, 3.7, 67, 4.3),
  createData('Toyota Aqua + 2019', 356, 16.0, 49, 3.9),
];
